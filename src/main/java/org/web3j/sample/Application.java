...
public class Application {
    ...
    private void run() throws Exception {
        ...
        Web3j web3j = Web3j.build(new HttpService(
                "https://rinkeby.infura.io/v3/c919bb51fbcc481b832de0a3b60cac02"));  // FIXME: Enter your Infura token here;
        ...
        Credentials credentials =
                WalletUtils.loadCredentials(
                        "rinkeby",
                        "D:\\rinkeby_keystore\\UTC--2018-11-06T09-39-44.558000000Z--c27b4dc5f139179da96ebe0bf712d098a42fbb02.json");
        ...
        TransactionReceipt transferReceipt = Transfer.sendFunds(
                web3j, credentials,
                "0x53b753981d0c1fe8723a16c109e5e0caaa8df88c",  // you can put any address here
